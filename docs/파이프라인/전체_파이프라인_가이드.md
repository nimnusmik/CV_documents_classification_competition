...
flowchart TD
    ...
    style OPTUNA_MAIN fill:#fff3e0, color:#000000
    style EXPERIMENTS fill:#ffebee, color:#000000
```
...
│   ├── optuna_config.yaml                 # 하이퍼파라미터 튜닝 설정 (K-fold)
...
# 🚀 단일 폴드 최적화 (신규 - 매우 빠름, 2025.09.10 추가)
python src/training/train_main.py \
